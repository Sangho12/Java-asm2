...
public class AnnotationProcessor {
    ...
    public static void OutputProcessor(String methodName, Class<?> clazz, ArrayList<student_admission_record_finished> returnvalue) {
        try {
            Method method = clazz.getMethod(methodName, File.class);
            if (method.isAnnotationPresent(Output.class)) {
                for (student_admission_record_finished a : returnvalue) {
    ...
    public static boolean FailCustomValidate(student_admission_record_finished stu, Class<?> clazz) {
